...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {cq: fragment, ct: host, cG: path, cI: port_, cM: protocol, cN: query};
	});
...
var $author$project$Model$Model = F3(
	function (ztable, content, searchedValue) {
		return {da: content, du: searchedValue, dC: ztable};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Model$init = function (_v0) {
	return _Utils_Tuple2(
		A3($author$project$Model$Model, $elm$core$Maybe$Nothing, '', $elm$core$Maybe$Nothing),
...
var $author$project$Utils$convertTuple2StringToTuple2Float = function (_v0) {
	var a = _v0.a;
	var b = _v0.b;
	var parsedB = $elm$core$String$toFloat(b);
	var parsedA = $elm$core$String$toFloat(a);
	var _v1 = _Utils_Tuple2(parsedA, parsedB);
	if ((!_v1.a.$) && (!_v1.b.$)) {
		var floatA = _v1.a.a;
		var floatB = _v1.b.a;
		return $elm$core$Maybe$Just(
			A2($elm$core$Tuple$pair, floatA, floatB));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$ZTable$findp = F2(
	function (z, table) {
		return A2(
...
var $author$project$ZTable$absDelta = F2(
	function (a, b) {
...
var $author$project$ZTable$filterWithValue = function (v) {
...
var $author$project$ZTable$selectBetterEntry = function (l) {
	return A2(
		$elm_community$list_extra$List$Extra$getAt,
		(($elm$core$List$length(l) - 1) / 2) | 0,
		l);
};
var $author$project$ZTable$findz = F2(
	function (p, table) {
		var deltaTable = A2(
			$elm$core$List$map,
			$elm$core$Tuple$mapSecond(
				$author$project$ZTable$absDelta(p)),
			table);
		var minimumDelta = A2(
			...
			F2(
				function (_v0, _v1) {
					var deltaA = _v0.b;
					var deltaB = _v1.b;
					return A2($elm$core$Basics$compare, deltaA, deltaB);
				}),
			deltaTable);
		return A2(
			$elm$core$Maybe$andThen,
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$Basics$composeR,
						function (v) {
							return A2($author$project$ZTable$filterWithValue, v, deltaTable);
						},
						$author$project$ZTable$selectBetterEntry)),
				minimumDelta));
	});
...
var $lovasoa$elm_csv$Csv$parseWith = F2(
	function (separator, lines) {
		...
		return {cr: headers, ds: records};
	});
var $lovasoa$elm_csv$Csv$parse = $lovasoa$elm_csv$Csv$parseWith(',');
var $elm$file$File$toString = _File_toString;
var $author$project$Utils$tuple2 = function (list) {
	...
	function (msg, model) {
		switch (msg.$) {
						...
						model,
						{
							dC: $elm$core$Maybe$Just(
								A2(
									...
									$author$project$Utils$convertTuple2StringToTuple2Float,
									A2(
										$elm$core$List$filterMap,
										$author$project$Utils$tuple2,
										$lovasoa$elm_csv$Csv$parse(content).ds)))
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				var text = msg.a;
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 4:
				var number = $elm$core$String$toFloat(model.da);
				var searchedValue = function () {
					var _v1 = _Utils_Tuple2(number, model.dC);
					if ((!_v1.a.$) && (!_v1.b.$)) {
						var z = _v1.a.a;
						var ztable = _v1.b.a;
						return A2($author$project$ZTable$findp, z, ztable);
					} else {
						return $elm$core$Maybe$Nothing;
					}
				}();
			...
			default:
				var number = $elm$core$String$toFloat(model.da);
				var searchedValue = function () {
					var _v2 = _Utils_Tuple2(number, model.dC);
					if ((!_v2.a.$) && (!_v2.b.$)) {
						var p = _v2.a.a;
						var table = _v2.b.a;
						return A2($author$project$ZTable$findz, p, table);
					} else {
						return $elm$core$Maybe$Nothing;
					}
				}();
...
var $author$project$Model$CsvRequested = {$: 0};
var $author$project$Model$OnContentChanged = function (a) {
	return {$: 3, a: a};
};
var $author$project$Model$SearchPValue = {$: 4};
var $author$project$Model$SearchZValue = {$: 5};
...
var $rundis$elm_bootstrap$Bootstrap$Internal$Button$defaultOptions = {aG: _List_Nil, aJ: false, v: $elm$core$Maybe$Nothing, aT: false, bD: $elm$core$Maybe$Nothing};
...
var $rundis$elm_bootstrap$Bootstrap$Internal$Button$buttonAttributes = function (modifiers) {
	...
	return _Utils_ap(
		...
		_Utils_ap(
			function () {
				var _v0 = A2($elm$core$Maybe$andThen, $rundis$elm_bootstrap$Bootstrap$General$Internal$screenSizeOption, options.bD);
				if (!_v0.$) {
					var s = _v0.a;
					return _List_fromArray(
						[
...
var $rundis$elm_bootstrap$Bootstrap$Form$col = F2(
	function (options, children) {
		return {cj: children, cn: $elm$html$Html$div, b0: options};
	});
...
var $author$project$View$searchedValueView = function (value) {
	if (!value.$) {
		var x = value.a;
		return A2(
			$elm$html$Html$h1,
		...
		switch (modifier.$) {
			...
			case 6:
				...
				return _Utils_update(
					options,
					{
						bO: $elm$core$Maybe$Just(validation_)
					});
			case 8:
				var val = modifier.a;
				return _Utils_update(
...
var $rundis$elm_bootstrap$Bootstrap$Form$Input$defaultOptions = {aG: _List_Nil, aT: false, ab: $elm$core$Maybe$Nothing, bf: $elm$core$Maybe$Nothing, bm: $elm$core$Maybe$Nothing, ak: false, bx: false, bD: $elm$core$Maybe$Nothing, am: 0, bO: $elm$core$Maybe$Nothing, s: $elm$core$Maybe$Nothing};
...
var $rundis$elm_bootstrap$Bootstrap$Form$Input$toAttributes = function (modifiers) {
	...
	return _Utils_ap(
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(
				options.ak ? 'form-control-plaintext' : 'form-control'),
				$elm$html$Html$Attributes$disabled(options.aT),
				$elm$html$Html$Attributes$readonly(options.bx || options.ak),
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$core$Maybe$andThen, $rundis$elm_bootstrap$Bootstrap$Form$Input$sizeAttribute, options.bD),
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$value, options.s),
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$placeholder, options.bm),
						A2($elm$core$Maybe$map, $elm$html$Html$Events$onInput, options.bf),
						A2($elm$core$Maybe$map, $rundis$elm_bootstrap$Bootstrap$Form$Input$validationAttribute, options.bO)
					])),
			options.aG));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Model$CsvRequested),
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Charger une table Z au format CSV (.csv)')
								]))
						]))
				]));
	} else {
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rundis$elm_bootstrap$Bootstrap$Form$Input$placeholder('Valeur à rechercher'),
															$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput($author$project$Model$OnContentChanged),
															$rundis$elm_bootstrap$Bootstrap$Form$Input$value(model.da)
														]))
												])),
											A2(
											$rundis$elm_bootstrap$Bootstrap$Form$col,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rundis$elm_bootstrap$Bootstrap$Button$primary,
															$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Model$SearchPValue),
															$rundis$elm_bootstrap$Bootstrap$Button$block
														]),
													_List_fromArray(
														[
															$elm$html$Html$text('Rechercher P')
														]))
												])),
											A2(
											$rundis$elm_bootstrap$Bootstrap$Form$col,
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$rundis$elm_bootstrap$Bootstrap$Button$primary,
															$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Model$SearchZValue),
															$rundis$elm_bootstrap$Bootstrap$Button$block
														]),
													_List_fromArray(
														[
															$elm$html$Html$text('Rechercher Z')
														]))
												]))
										]))
								])),
							$author$project$View$searchedValueView(model.du)
						]))
				]));
	}
};
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Lecteur de table Z')
											]))
									]))
							])),
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{dj: $author$project$Model$init, dx: $author$project$Subscriptions$subscriptions, dz: $author$project$Update$update, dA: $author$project$View$view});
